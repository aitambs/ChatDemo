...
public class Message {
    ...
    /**
     * Get the Messege's content
     * @return the Messege's content
     */
    ...
    /**
     * Get the Messege's content length in bytes
     * @return the Messege's content lengh in bytes
     */
    ...
    /**
     * Get the Messege's content hash code
     * @return the Messege's content hash code
     */
    public int getHash() {
        return hash;
    }
    ...
    /**
     * Get the Messege's timestamp
     * @return the Messege's timestamp
     */
